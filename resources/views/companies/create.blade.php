                ...
                <form class="w-full my-8" action="{{ route('companies.store') }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="company-name" name="name" type="text" placeholder="ie: madewithlove">
